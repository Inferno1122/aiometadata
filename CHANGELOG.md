...
## [1.9.0](https://github.com/Inferno1122/aiometadata/compare/v1.8.3...v1.9.0) (2025-11-14)
...
* Add granular RPDB control, anime movie mappings, and catalog warmer fixes ([3bef3b1](https://github.com/Inferno1122/aiometadata/commit/3bef3b197726789a46aba8d0332e674198053ef5))
...
* add more providers ([7bf97b9](https://github.com/Inferno1122/aiometadata/commit/7bf97b976411b602e09395573ef81922a62ffab1))
...
* **catalogs:** Add per-catalog randomization controls ([9ac3d89](https://github.com/Inferno1122/aiometadata/commit/9ac3d89b33bcfd07be7715d19ed17b2f068a2448))
* **catalogs:** Add TVMaze daily schedule catalog ([15e928b](https://github.com/Inferno1122/aiometadata/commit/15e928b0c00342f6772def0bc473e6ef2c6a7776))
...
* **custom-manifest:** Add proxy endpoint for Docker network manifest URLs ([9083e12](https://github.com/Inferno1122/aiometadata/commit/9083e12c4bb2f842df30d3874747e9a86e8d344e))
...
* start implementing mdblist watch status ([c391f88](https://github.com/Inferno1122/aiometadata/commit/c391f8848943dc16e9c3abeedc99d72f47ed4ed5))
...
* **ui:** Track Kitsu search performance and improve nav ([01f66aa](https://github.com/Inferno1122/aiometadata/commit/01f66aa95a92d056bd6d9a8cdacb1d8fb5fafd90))
...
* **anime meta & fanart:** fix self-inflicted initialization issue and re apply langugage selection logic to fanart ([af1b8ec](https://github.com/Inferno1122/aiometadata/commit/af1b8ec459c498681087a7124a2bf71413e9dd16))
* **anime meta:** issue with anime override & filter out null names from cast/crew ([f5e633d](https://github.com/Inferno1122/aiometadata/commit/f5e633d1135d2d1b925797379fe27134199278db))
* **anime movie:** adapt ids to new anime movie id mapping ([0ca12cc](https://github.com/Inferno1122/aiometadata/commit/0ca12cc5832f5c50662ccf73b78cba101d1c4ada))
...
* **art:** RPDB handling and improve error resilience ([eafe942](https://github.com/Inferno1122/aiometadata/commit/eafe9422ab0d23e62bfdd1afbc013fb2b8b757ec))
...
* **cache:** fix cache key mismatch in meta wrap smart by aligning animeIdProvider logic ([c4571e4](https://github.com/Inferno1122/aiometadata/commit/c4571e44444fa1fa54379d63638faa8b79358f7e))
* **cache:** Handle cache key correctly for anime id provider when using imdb id for anime ([36453f3](https://github.com/Inferno1122/aiometadata/commit/36453f391c1be15dbf122cbdb103cc61dc938dec))
* **cache:** Track meta cache hits correctly and prevent double-counting misses ([4b59363](https://github.com/Inferno1122/aiometadata/commit/4b5936368aaaee14cfbd61037c0b52680008450e))
...
* **custom catalogs:** allow configuring page size for imports to fix pagination for addons that use less than 100 as page size ([683205b](https://github.com/Inferno1122/aiometadata/commit/683205ba45109bfc8047d333a9b1f636a4515468))
...
* decouple html blurb from user configs ([2ed1aeb](https://github.com/Inferno1122/aiometadata/commit/2ed1aeb3100667c1f37846d16cbcf1a86bfb1e11))
* decouple html blurb from user configs ([fdedabb](https://github.com/Inferno1122/aiometadata/commit/fdedabb779179356540ce08449f2b3ddec75cdba))
...
* **fanart:** adapt changes from fanart api ([8b3d006](https://github.com/Inferno1122/aiometadata/commit/8b3d006d3e60da1b3aee99bd9b193c2f1a288324))
* finetune person's search logic further ([#99](https://github.com/Inferno1122/aiometadata/issues/99)) ([5df4cc6](https://github.com/Inferno1122/aiometadata/commit/5df4cc6a29a2d8adb43ba611f48aefcd404b9e39))
...
* make persons search strict ([02cf696](https://github.com/Inferno1122/aiometadata/commit/02cf69696478dfeb7d93ee8c7e60bcbc0edf0053))
* make persons search strict ([4d253b2](https://github.com/Inferno1122/aiometadata/commit/4d253b25b6f367b5f4c7909ca5040bd009b120b2))
* make skygo region agnostic ([ca8c08c](https://github.com/Inferno1122/aiometadata/commit/ca8c08cb0eddba3b8a3b12bb5958809a4dbe8c23))
...
* **meta:** anime ID provider check logic ([17c7828](https://github.com/Inferno1122/aiometadata/commit/17c7828051d208062c873f41c23901e31e9d9ae0))
...
* **meta:** fix anime id condition issue ([9a22e0e](https://github.com/Inferno1122/aiometadata/commit/9a22e0e8ce3b9bdfead2ac53ddae77f9958a3986))
...
* **meta:** fix undefined certificationsData and empty ids handling ([7c66530](https://github.com/Inferno1122/aiometadata/commit/7c665305d9322e92959bcdd15d62948218729a5e))
* **meta:** prevent getMeta from being called if imdb id isnt found when Use IMDb ID for Catalog/Search for Series is On ([f566121](https://github.com/Inferno1122/aiometadata/commit/f566121f768e2c9787d8e38182c733f268b40074))
...
* **search:** Improve search provider labeling ([c22ee47](https://github.com/Inferno1122/aiometadata/commit/c22ee47afae5dbe946ab85632b609a6b1b956d19))
...
* **tmdb meta:** Use original_title when user language matches original language and no translation exists ([56ff1e1](https://github.com/Inferno1122/aiometadata/commit/56ff1e1975d2cf7621c05dc06a93b25e20d01303))
* **tmdb trailers:** fix multilingual trailers logic ([cc4a088](https://github.com/Inferno1122/aiometadata/commit/cc4a088ad7a98b5d8e98a926ccfd6c3cd4eda4b0))
...
* **trakt up next:** fix issue with caching ([b44be7c](https://github.com/Inferno1122/aiometadata/commit/b44be7c81bad2bd6c7550b8cea63ec8d8678dd01))
...
* TVDB collections movies-only, TVMaze schedule improvements ([c47746a](https://github.com/Inferno1122/aiometadata/commit/c47746ab4c451eb1cf94357d79e69e0ae7df9656))
...
* **tvdb genre:** TVDB genres pagination by using correct pageSize from env var ([1fef78e](https://github.com/Inferno1122/aiometadata/commit/1fef78e467d24a54543d98f4a92d6644620b66fa))
...
* **tvmaze:** Update schedule API from web to full and adapt new response structure ([27cbacd](https://github.com/Inferno1122/aiometadata/commit/27cbacd21b1651335fa89659b92f349250104810))
